        ...
        <div class="content-wrapper">
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Invitation for Bids/Quotations List</h4>
                    ...
                    >
                      ...
                      <tbody>
                        <tr :key="index" v-for="(detail, index) in bids">
                          <td>{{ index + 1 }}</td>
                          <td>{{ detail.name }}  </td>
                          <td>Procurement Plan {{ getFormattedDate(detail.financial_year_start) }} - {{ getFormattedDate(detail.financial_year_end) }}  </td>
                          <td><a href="#">Bids</a> </td>
                          <td>{{ detail.type }}  </td>
                          <td>{{ new Date(detail.deadline).toLocaleString() }}  </td>
                          <td>{{ new Date(detail.display_start_date).toLocaleString() }}   </td>
                          <td>{{ new Date(detail.display_end_date).toLocaleString() }}   </td>
                          <td>{{ detail.status }}  </td>
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    <h4 class="modal-title">
                      {{
                        editMode ? "Edit Bid Invitation Details" : "Create Bid Invitation Details"
                      }}
                    </h4>
                    <button
                      type="button"
                        ...
                        <div class="row">
                          <div class="col-md-12">
                            <div class="form-group">
                              ...
                              >
                                ...
                                <option
                                  ...
                                  :value="plan.id"
                                >
                                  FY {{ getFormattedDate(plan.financial_year_start) }} - {{ getFormattedDate(plan.financial_year_end) }}
                                </option>
                              </select>
                              <div
                                v-if="errors.plan_id"
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="">Subject of Procurement
</label>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="role_name">Reference Number</label>
                                    </div>
                              ...
                              <div
                                ...
                                class="invalid-feedback"
                              >
                                <div v-if="errors.reference_number" class="error">
                                  {{
                                    errors.reference_number ? errors.reference_number[0] : ""
                                  }}
                                </div>
                              </div>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="role_name">Submission Deadline</label>
                                    </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="role_name">Display Period From</label>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <input
                                            type="date"
                                            class="form-control"
                                            :class="{ 'is-invalid': errors.display_start_date }"
                                            name="display_start_date"
                                            v-model="form.display_start_date"
                                            placeholder=""
                                        />
                                        <div v-if="errors.display_start_date" class="invalid-feedback">
                                <div v-if="errors.display_start_date" class="error">
                                  {{ errors.display_start_date ? errors.display_start_date[0] : "" }}
                                </div>
                              </div>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="role_name">Display Period To</label>
                                    </div>
                                    ...
                                    <div class="col-md-8">
                                        <input
                                            type="date"
                                            class="form-control"
                                            :class="{ 'is-invalid': errors.display_end_date }"
                                            name="display_end_date"
                                            v-model="form.display_end_date"
                                            placeholder=""
                                        />
                                        <div v-if="errors.display_end_date" class="invalid-feedback">
                                <div v-if="errors.display_end_date" class="error">
                                  {{ errors.display_end_date ? errors.display_end_date[0] : "" }}
                                </div>
                              </div>
