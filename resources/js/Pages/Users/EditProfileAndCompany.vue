                              ...
                              <fieldset>
                                ...
                                <div class="form-group">
                                  ...
                                  <div
                                    ...
                                    v-if="!$v.form.organisationName.required"
                                  >
                                ...
                                <div class="form-group">
                                  ...
                                  <div
                                    class="invalid-feedback"
                                    v-if="!$v.form.briefDescription.required"
                                  >
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div
                                            class="invalid-feedback"
                                            v-if="
                                              !$v.form.secretQuestion.required
                                            "
                                          >
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input
                                        ...
                                        class="form-control"
                                        :class="{
                                          'is-invalid': $v.form.region.$error,
                                        }"
                                  ...
                                  <div class="col-md-6">
                                    <div class="form-group">
                                      ...
                                      <input
                                        ...
                                        class="form-control"
                                        :class="{
                                          'is-invalid': $v.form.zipCode.$error,
                                        }"
