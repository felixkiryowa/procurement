                    ...
                    <div class="form-group">
                      ...
                      <div v-if="errors.new_password"
                        class="invalid-feedback">
                            <div v-if="errors.new_password"
                        class="error">{{errors.new_password?errors.new_password[0]:''}}</div>
                      </div>
                    </div>
                    <div class="form-group">
                      ...
                      <div v-if="errors.new_confirm_password"
                        class="invalid-feedback">
                        <div v-if="errors.new_confirm_password"
                        class="error">{{errors.new_confirm_password?errors.new_confirm_password[0]:''}}</div>
                        </div>
                    </div>
