...
class OpenningAccountBalancesTrio extends Model
{
    use HasFactory;
    ...
    public  function calculate_amount_on_accounts($account_number, $account_id, $account_level,  $start_date)
    {
        ...
        if ($account_level == 1) {
            ...
            $result = $this->calculate_total_amounts_on_top_accounts($account_group, $account_number ,  $start_date);
            ...
            $result = $this->calculate_total_amounts_on_sub_bank_accounts($account_group, $account_number ,  $start_date);
            ...
            $result = $this->calculate_total_amounts_on_last_bank_accounts($account_group, $account_number ,  $start_date);
    ...
    public  function get_amounts_on_last_accounts_below_sub_accounts($account_group, $category ,  $start_date)
    {
        $credits = 0;
        $deposits = 0;
            ...
            foreach ($account_group as $value3) {
                $journal_entries3 = DB::table('general_ledgers')
                    ...
                    ->whereDate('general_ledgers.created_at', '<', $start_date)
                    ->get();
    ...
    public  function get_amounts_on_top_accounts($account_group, $category , $start_date)
    {
        $credits = 0;
        $deposits = 0;
    ...
    public  function get_amounts_on_sub_accounts($account_group, $category , $start_date)
    {
        $credits = 0;
        $deposits = 0;
    ...
    public  function calculate_total_amounts_on_top_accounts($account_group, $account_number , $start_date)
    {
        ...
        if ($first_letter == '3') {
            // ASSETS ACCOUNT
            $result = $this->get_amounts_on_top_accounts($account_group, '3' , $start_date);
            //ASSETS ACCOUNT
        } else if ($first_letter == '4') {
            //LIABILITIES
            $result = $this->get_amounts_on_top_accounts($account_group, '4' , $start_date);
            //LIABILITIES

        } else if ($first_letter == '2') {
            //EXPENSES
            $result = $this->get_amounts_on_top_accounts($account_group, '2' , $start_date);
            //EXPENSES
        } else if ($first_letter == '1') {
            //REVENUE
            $result = $this->get_amounts_on_top_accounts($account_group, '1' , $start_date);
            //REVENUE
        } else {
            // EQUITY ACCOUNT
            $result = $this->get_amounts_on_top_accounts($account_group, '5' , $start_date);
            // EQUITY ACCOUNT
        }
    ...
    public  function calculate_total_amounts_on_sub_bank_accounts($account_group, $account_number , $start_date)
    {
        //LOGIC  TO DO  CHECK WHETHER IT IS A DEBIT OR CREDIT
        ...
        if ($check_if_its_generated_account_company_aggregated_account) {
            ...
            if ($first_letter == '3') {
                // ASSETS ACCOUNT
                $result = $this->get_amounts_on_sub_accounts($account_group, '3' , $start_date);
                // ASSETS ACCOUNT
            } else if ($first_letter == '4') {
                // LIABILITIES
                $result = $this->get_amounts_on_sub_accounts($account_group, '4' , $start_date);
                // LIABILITIES
            } else if ($first_letter == '2') {
                // EXPENSES
                $result = $this->get_amounts_on_sub_accounts($account_group, '2' , $start_date);
                // EXPENSES
            } else if ($first_letter == '1') {
                // REVENUE
                $result = $this->get_amounts_on_sub_accounts($account_group, '1' , $start_date);
                // REVENUE
            } else {
                // EQUITY ACCOUNT
                $result = $this->get_amounts_on_sub_accounts($account_group, '5' , $start_date);
                // EQUITY ACCOUNT
            }
    ...
    public  function calculate_total_amounts_on_last_bank_accounts($account_group, $account_number , $start_date)
    {
        //LOGIC  TO DO  CHECK WHETHER IT IS A DEBIT OR CREDIT
        $specific_account_number = $account_number;
        //SEPARATING THE ACCOUNT TO GET PARTS OF AN ACCOUNT
        ...
        if ($first_letter == '3') {
            // ASSETS ACCOUNT
            $result = $this->get_amounts_on_last_accounts_below_sub_accounts($account_group, '3' , $start_date);
            //ASSETS ACCOUNT
        } else if ($first_letter == '4') {
            //LIABILITIES
            $result = $this->get_amounts_on_last_accounts_below_sub_accounts($account_group, '4' , $start_date);
            //LIABILITIES

        } else if ($first_letter == '2') {
            //EXPENSES
            $result = $this->get_amounts_on_last_accounts_below_sub_accounts($account_group, '2' , $start_date);
            //EXPENSES
        } else if ($first_letter == '1') {
            //REVENUE
            $result = $this->get_amounts_on_last_accounts_below_sub_accounts($account_group, '1' , $start_date);
            //REVENUE
        } else {
            // EQUITY ACCOUNT
            $result = $this->get_amounts_on_last_accounts_below_sub_accounts($account_group, '5' , $start_date);
            // EQUITY ACCOUNT
        }
